"""
Description: I would allow for passengers to be able to pay a small fee to make upgraded accomodations of seating together or choosing their seatings arrangements with multiple parties. If one the day of the flight the plane is not filled then parties should be allowed to change their seats to sit together if the groupings are avaiable. 
